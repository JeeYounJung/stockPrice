...
MM <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/MM.csv") %>%
  select(Date, Symbol, High, Low)
SBIN <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/SBIN.csv") %>%
  select(Date, Symbol, High, Low)
POWERGRID <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/POWERGRID.csv") %>%
  select(Date, Symbol, High, Low)
ONGC <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/ONGC.csv") %>%
  select(Date, Symbol, High, Low)
BPCL <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/BPCL.csv") %>%
  select(Date, Symbol, High, Low)
ASIANPAINT <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/ASIANPAINT.csv") %>%
  select(Date, Symbol, High, Low)
ADANIPORTS <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/ADANIPORTS.csv") %>%
  select(Date, Symbol, High, Low)
CIPLA <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/CIPLA.csv") %>%
  select(Date, Symbol, High, Low)
ITC <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/ITC.csv") %>%
  select(Date, Symbol, High, Low)
WIPRO <- read.csv("/Users/jeeyounjung/Desktop/STAT 436/HW2/stockM/WIPRO.csv") %>%
  select(Date, Symbol, High, Low)
